...
## RANKED HYPOTHESES 2026-09-12 19:37:44 UTC
- [42] api.777.dev: api.777.dev / released 777.dev member as credentialed trust root (residual chain) (from art/lead_bigpickle.txt)
- NEXT(hypotheses-bigpickle.txt): HUMAN: submit at bugs.olivermaicher.eu — (a) Roobet CORS NAMESPACE-wide trust: ACAO+ACAC:true for any `*.777.dev` incl. non-resolving www.777.dev (live-reverifi
- NEXT(hypotheses-nemotron3.txt): PROBE: GET https://rainbet-com-rabbitmq.rainbet.com:15671/api/overview -H "Accept: application/json" — capture 401 response headers and body; GET https://rainbe
- LEARN: ACCEPTED OTHER @ roobet.com/_api CORS: live probe this cycle — GET /_api/currency/balances, Origin https://www.777.dev → 200 + ACAO reflected + ACAC:true; Origi
- LEARN: ACCEPTED MISCONFIG @ betpandacasino.io/rest/user/details: live probe this cycle — 200 JSON user-state model (loggedIn=false, blockedStatus=NONE, country=US, kyc
- LEARN: ACCEPTED OTHER @ avatarux-studios passive surface: delta empty — broker /api 401, casino config/callback 404, help.desk 303, cpanel takeover monitoring-only; pa
- LEARN: ACCEPTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com / rainbet-us-staging-rabbitmq.rainbet.com: RabbitMQ Management UI (15671/15672) + AMQP (5671/5672) public 
- LEARN: ACCEPTED OTHER @ staging-api.rainbet.com: x-do-app-origin: 1ce4ff55-e85f-4c30-8033-5129a1812504 (DO App Platform origin UUID) leaks through Cloudflare on 200-em
- LEARN: ACCEPTED OTHER @ api.777.dev: live Express/session backend (connect.sid, helmet, ACAC:true preset, CF 104.18.43.25); prod CORS whitelist origin is a real runnin
- LEARN: ACCEPTED OTHER @ 777.dev zone: 11/11 cert-name members resolve to Roobet CF pair; non-resolving www.777.dev still reflects ACAO — namespace-trust evidence compl
...
## RANKED HYPOTHESES 2026-09-12 21:41:42 UTC
- [90] rainbet-com-rabbitmq.rainbet.com:15671,15672,5671,5672: RainBet RabbitMQ Management UI + AMQP Exposed on Raw DigitalOcean Origins (from art/lead_nemotron3.txt)
- [72] api.777.dev/graphql: Staging api-graphql introspection + workload fingerprint (schema disclosure) (from art/lead_bigpickle.txt)
- NEXT(hypotheses-bigpickle.txt): HUMAN: at bugs.olivermaicher.eu extend pending submission with the new api.777.dev/graphql finding (introspection-enabled Apollo `api-graphql` staging workload,
- NEXT(hypotheses-nemotron3.txt): PROBE: GET https://rainbet-com-rabbitmq.rainbet.com:15671/ -H "Accept: text/html" — capture management UI landing page for version/clustering hints; GET https:/
- LEARN: ACCEPTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com / rainbet-us-staging-rabbitmq.rainbet.com: RabbitMQ Management UI (15671/15672) + AMQP (5671/5672) public 
- LEARN: ACCEPTED OTHER @ staging-api.rainbet.com: x-do-app-origin: 1ce4ff55-e85f-4c30-8033-5129a1812504 (DO App Platform origin UUID) leaks through Cloudflare on 200-em
- LEARN: ACCEPTED OTHER @ api.777.dev: live Express/session backend (connect.sid, helmet, ACAC:true preset, CF 104.18.43.25); prod CORS whitelist origin is a real runnin
- LEARN: ACCEPTED OTHER @ 777.dev zone: 11/11 cert-name members resolve to Roobet CF pair; non-resolving www.777.dev still reflects ACAO — namespace-trust evidence compl
...
## RANKED HYPOTHESES 2026-09-12 23:22:13 UTC
- [90] rainbet-com-rabbitmq.rainbet.com:15671,15672,5671,5672: RainBet RabbitMQ Management UI + AMQP Exposed on Raw DigitalOcean Origins (from art/lead_nemotron3.txt)
- [42] api.777.dev: api.777.dev / released 777.dev member as credentialed trust root (residual chain) (from art/lead_bigpickle.txt)
- NEXT(hypotheses-bigpickle.txt): HUMAN: submit at bugs.olivermaicher.eu — (a) Roobet CORS NAMESPACE-wide trust: ACAO+ACAC:true for any `*.777.dev` incl. non-resolving www.777.dev (live-reverifi
- NEXT(hypotheses-nemotron3.txt): PROBE: GET https://rainbet-com-rabbitmq.rainbet.com:15671/ -H "Accept: text/html" — capture management UI landing page for version/clustering hints; GET https:/
...
## RANKED HYPOTHESES 2026-09-13 01:14:21 UTC
- [75] rainbet-com-rabbitmq.rainbet.com:15671/api: RainBet RabbitMQ Anonymous Queue/Exchange Enumeration via Management API (from art/lead_nemotron3.txt)
- [68] affiliates.betpanda.io/rest/player/uid/{uid}: Affiliate BOLA on /rest/player/uid/{uid} (cross-player iteration) (from art/lead_bigpickle.txt)
- NEXT(hypotheses-bigpickle.txt): HUMAN: extend pending bugs.olivermaicher.eu submission with this cycle's data point — anonymous field sweep of api.777.dev/graphql (10 data fields; only getSpor
- NEXT(hypotheses-nemotron3.txt): PROBE: GET https://rainbet-com-rabbitmq.rainbet.com:15671/api/queues -H "Accept: application/json" — test anonymous queue enumeration on production RabbitMQ man
- LEARN: ACCEPTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com / rainbet-us-staging-rabbitmq.rainbet.com: RabbitMQ Management UI (15671/15672) + AMQP (5671/5672) public 
- LEARN: ACCEPTED OTHER @ staging-api.rainbet.com: x-do-app-origin: 1ce4ff55-e85f-4c30-8033-5129a1812504 (DO App Platform origin UUID) leaks through Cloudflare on 200-em
- LEARN: ACCEPTED OTHER @ api.777.dev: live Express/session backend (connect.sid, helmet, ACAC:true preset, CF 104.18.43.25); prod CORS whitelist origin is a real runnin
- LEARN: ACCEPTED OTHER @ 777.dev zone: 11/11 cert-name members resolve to Roobet CF pair; non-resolving www.777.dev still reflects ACAO — namespace-trust evidence compl
...
## RANKED HYPOTHESES 2026-09-13 06:20:35 UTC
- [78] rainbet-com-rabbitmq.rainbet.com:15671/api: RainBet RabbitMQ Anonymous Queue/Exchange Enumeration via Management API (from art/lead_nemotron3.txt)
- NEXT(hypotheses-nemotron3.txt): PROBE: GET https://rainbet-com-rabbitmq.rainbet.com:15671/api/queues -H "Accept: application/json" — test anonymous queue enumeration on production RabbitMQ man
- LEARN: ACCEPTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com / rainbet-us-staging-rabbitmq.rainbet.com: RabbitMQ Management UI (15671/15672) + AMQP (5671/5672) public 
- LEARN: ACCEPTED OTHER @ staging-api.rainbet.com: x-do-app-origin: 1ce4ff55-e85f-4c30-8033-5129a1812504 (DO App Platform origin UUID) leaks through Cloudflare on 200-em
- LEARN: ACCEPTED OTHER @ api.777.dev: live Express/session backend (connect.sid, helmet, ACAC:true preset, CF 104.18.43.25); prod CORS whitelist origin is a real runnin
...
## RANKED HYPOTHESES 2026-09-13 12:03:09 UTC
- [78] rainbet-com-rabbitmq.rainbet.com:15671/api: RainBet RabbitMQ Anonymous Queue/Exchange Enumeration via Management API (from art/lead_nemotron3.txt)
- [68] affiliates.betpanda.io/rest/player/uid/{uid}: Affiliate BOLA on /rest/player/uid/{uid} (cross-player iteration) (from art/lead_bigpickle.txt)
- NEXT(hypotheses-bigpickle.txt): HUMAN: at bugs.olivermaicher.eu extend the pending submission — add this cycle's negative evidence (api.777.dev 14-path sweep, CORS controls clean, RabbitMQ /ap
- NEXT(hypotheses-nemotron3.txt): PROBE: GET https://rainbet-com-rabbitmq.rainbet.com:15671/api/queues -H "Accept: application/json" — test anonymous queue enumeration on production RabbitMQ man
- LEARN: ACCEPTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com / rainbet-us-staging-rabbitmq.rainbet.com: RabbitMQ Management UI (15671/15672) + AMQP (5671/5672) public 
- LEARN: ACCEPTED OTHER @ staging-api.rainbet.com: x-do-app-origin: 1ce4ff55-e85f-4c30-8033-5129a1812504 (DO App Platform origin UUID) leaks through Cloudflare on 200-em
- LEARN: ACCEPTED OTHER @ api.777.dev: live Express/session backend (connect.sid, helmet, ACAC:true preset, CF 104.18.43.25); prod CORS whitelist origin is a real runnin
...
## RANKED HYPOTHESES 2026-09-13 16:28:46 UTC
- [78] roobet.com/_api: Roobet Production Game API Credentialed Requests via Compromised *.777.dev Staging Origin (from art/lead_bigpickle.txt)
- [78] rainbet-com-rabbitmq.rainbet.com:15671/api: RainBet RabbitMQ Anonymous Queue/Exchange Enumeration via Management API (from art/lead_nemotron3.txt)
- NEXT(hypotheses-bigpickle.txt): PROBE: GET https://rainbet-com-rabbitmq.rainbet.com:15671/api/queues -H "Accept: application/json" — test anonymous queue enumeration on production RabbitMQ man
- NEXT(hypotheses-nemotron3.txt): PROBE: GET https://rainbet-com-rabbitmq.rainbet.com:15671/api/queues -H "Accept: application/json"
- LEARN: ACCEPTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com / rainbet-us-staging-rabbitmq.rainbet.com: RabbitMQ Management UI (15671/15672) + AMQP (5671/5672) public 
- LEARN: ACCEPTED OTHER @ staging-api.rainbet.com: x-do-app-origin: 1ce4ff55-e85f-4c30-8033-5129a1812504 (DO App Platform origin UUID) leaks through Cloudflare on 200-em
- LEARN: ACCEPTED OTHER @ api.777.dev: live Express/session backend (connect.sid, helmet, ACAC:true preset, CF 104.18.43.25); prod CORS whitelist origin is a real runnin
- LEARN: ACCEPTED OTHER @ 777.dev zone: 11/11 cert-name members resolve to Roobet CF pair; non-resolving www.777.dev still reflects ACAO — namespace-trust evidence compl
...
## RANKED HYPOTHESES 2026-09-13 19:03:21 UTC
- [78] rainbet-com-rabbitmq.rainbet.com:15671/api: RainBet RabbitMQ Anonymous Queue/Exchange Enumeration via Management API (from art/lead_nemotron3.txt)
- [50] api.777.dev/graphql: api.777.dev GraphQL mutation pre-auth side-effect gap (fair-seed rotate / limits / raffle) (from art/lead_bigpickle.txt)
- NEXT(hypotheses-nemotron3.txt): PROBE: GET https://rainbet-com-rabbitmq.rainbet.com:15671/api/queues -H "Accept: application/json"
- LEARN: ACCEPTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com / rainbet-us-staging-rabbitmq.rainbet.com: RabbitMQ Management UI (15671/15672) + AMQP (5671/5672) public 
- LEARN: ACCEPTED OTHER @ staging-api.rainbet.com: x-do-app-origin: 1ce4ff55-e85f-4c30-8033-5129a1812504 (DO App Platform origin UUID) leaks through Cloudflare on 200-em
- LEARN: ACCEPTED OTHER @ api.777.dev: live Express/session backend (connect.sid, helmet, ACAC:true preset, CF 104.18.43.25); prod CORS whitelist origin is a real runnin
...
## RANKED HYPOTHESES 2026-09-13 21:29:53 UTC
- [78] rainbet-com-rabbitmq.rainbet.com:15671/api: Roobet Production Game API Credentialed Requests via Compromised *.777.dev Staging Origin (from art/lead_nemotron3.txt)
- [40] roobet.com/_api: Roobet /_api CORS staging-namespace trust chain (exploitation-leg re-test) (from art/lead_bigpickle.txt)
- NEXT(hypotheses-bigpickle.txt): HUMAN: at bugs.olivermaicher.eu extend the pending submission — add this cycle's negative evidence (api.777.dev 14-path sweep, CORS controls clean, RabbitMQ /ap
- NEXT(hypotheses-nemotron3.txt): PROBE: GET https://rainbet-com-rabbitmq.rainbet.com:15671/api/queues -H "Accept: application/json"
- LEARN: REJECTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com:15671/api/queues: anonymous queue enumeration falsified — HTTP 401 Basic identical to /api/overview; manag
- LEARN: ACCEPTED OTHER @ roobet.com/_api: connect.sid SameSite=Lax + HttpOnly — cross-site credentialed fetch/WS from *.777.dev excluded by browser cookie policy; CORS 
...
## RANKED HYPOTHESES 2026-09-14 01:20:45 UTC
- [85] rainbet-com-rabbitmq.rainbet.com:5671,: RainBet RabbitMQ AMQP Protocol Exposure on Raw DigitalOcean Origins (from art/lead_nemotron3.txt)
...
## RANKED HYPOTHESES 2026-09-14 13:39:25 UTC
- [85] rainbet-com-rabbitmq.rainbet.com:5671,: RainBet RabbitMQ AMQP Anonymous Protocol Access on Raw DigitalOcean Origins (from art/lead_nemotron3.txt)
- [68] affiliates.betpanda.io/rest/player/uid/{uid}: Affiliate BOLA on /rest/player/uid/{uid} cross-uid iteration (from art/lead_bigpickle.txt)
- NEXT(hypotheses-bigpickle.txt): HUMAN: register two credentialed affiliate test accounts on affiliates.betpanda.io under scoped authorization → cross-uid GET /rest/player/uid/{own} vs /rest/pl
- NEXT(hypotheses-nemotron3.txt): PROBE: openssl s_client -connect rainbet-com-rabbitmq.rainbet.com:5671 -quiet < /dev/null && echo "---" && nc -vz rainbet-com-rabbitmq.rainbet.com 5672
- LEARN: REJECTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com guest:guest default credentials — HTTP 401 "not_authorized" on /api/overview with Basic Z3Vlc3Q6Z3Vlc3Q= —
- LEARN: ACCEPTED OTHER @ rainbet-com-rabbitmq.rainbet.com:15671 — full management API endpoint census this cycle: /api/{overview,queues,exchanges,vhosts,connections,cha
- LEARN: ACCEPTED OTHER @ avatarux-studios live surface: 4 read-only GETs (casino /rest/user/details 200 301B sha256 4254af73; affiliates /rest/public/config 200 398B sh
- LEARN: ACCEPTED OTHER @ betpandacasino.io/rest/user/details: 200 JSON user-state model unauthenticated leak (301B) reconfirmed — report-ready finding unchanged, contro
- LEARN: ACCEPTED AUTH @ affiliates.betpanda.io/rest/player/uid/1: 401 anonymous boundary intact — BOLA classification requires credentialed cross-uid test, unchanged.
- LEARN: REJECTED MISCONFIG @ betpandacasino.io/rest/user/details x-site-name-id: stake_com → body/ACAO/echo unchanged — no passive tenant switch on user-state endpoint.
...
## RANKED HYPOTHESES 2026-09-14 18:53:53 UTC
- [68] affiliates.betpanda.io/rest/player/uid/{uid}: Affiliate BOLA on /rest/player/uid/{uid} cross-uid iteration (from art/lead_bigpickle.txt)

## RANKED HYPOTHESES 2026-09-14 22:20:41 UTC
- [70] betpandacasino.io/rest/user: BetPanda Casino Authenticated /rest/user/* Endpoint Census via Credentialed Session (from art/lead_nemotron3.txt)
- [68] affiliates.betpanda.io/rest/player/uid/{uid}: Affiliate BOLA on /rest/player/uid/{uid} cross-uid iteration (from art/lead_bigpickle.txt)
- NEXT(hypotheses-bigpickle.txt): HUMAN: register two credentialed affiliate test accounts on affiliates.betpanda.io under scoped authorization → cross-uid GET /rest/player/uid/{own} vs /rest/pl
- NEXT(hypotheses-nemotron3.txt): HUMAN: Obtain scoped credentialed session on betpandacasino.io (register test account) → enumerate authenticated /rest/user/* endpoints (me, profile, info, sett
- LEARN: REJECTED MISCONFIG @ betpandacasino.io/rest/user/details geo-spoof: X-Forwarded-For/True-Client-IP/X-Real-IP all ignored — `country` tied to real CF-attributed 
...
- LEARN: REJECTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com:5671,5672 / rainbet-us-staging-rabbitmq.rainbet.com:5671,5672: AMQP protocol requires authentication — ano
- LEARN: ACCEPTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com / rainbet-us-staging-rabbitmq.rainbet.com: RabbitMQ Management UI (15671/15672) + AMQP (5671/5672) public 
- LEARN: REJECTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com/api/*: /api/overview, /api/queues, /api/exchanges, /api/vhosts, /api/connections, /api/channels all 401 Ba
- LEARN: REJECTED MISCONFIG @ rainbet-us-staging-rabbitmq.rainbet.com:15671/15672: management ports fluxing (timeout) — only prod broker stable.
- LEARN: ACCEPTED OTHER @ roobet.com/_api: connect.sid SameSite=Lax + HttpOnly — cross-site credentialed fetch/WS from *.777.dev excluded by browser cookie policy; CORS 
...
## RANKED HYPOTHESES 2026-09-15 00:48:28 UTC
- [70] betpandacasino.io/rest/user: BetPanda Casino Authenticated /rest/user/* Endpoint Census via Credentialed Session (from art/lead_nemotron3.txt)
- [50] api.777.dev/graphql: Staging GraphQL mutation pre-auth side-effect gap on api.777.dev (from art/lead_bigpickle.txt)
- NEXT(hypotheses-bigpickle.txt): HUMAN: obtain scoped credentialed sessions (affiliate ×2, casino ×1, staging ×1) on bugs.olivermaicher.eu coordination — unlocks the only three remaining live h
- NEXT(hypotheses-nemotron3.txt): HUMAN: Obtain scoped credentialed session on betpandacasino.io (register test account) → enumerate authenticated /rest/user/* endpoints (me, profile, info, sett
- LEARN: ACCEPTED OTHER @ avatarux-studios live surface: 6 read-only GETs re-verified — aff config 200 398B, casino details 200 301B, help.desk portal/4 200 207443B (tem
- LEARN: REJECTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com:5671,5672 / rainbet-us-staging-rabbitmq.rainbet.com:5671,5672: AMQP protocol requires authentication — ano
- LEARN: ACCEPTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com / rainbet-us-staging-rabbitmq.rainbet.com: RabbitMQ Management UI (15671/15672) + AMQP (5671/5672) public 
- LEARN: REJECTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com/api/*: /api/overview, /api/queues, /api/exchanges, /api/vhosts, /api/connections, /api/channels all 401 Ba
- LEARN: REJECTED MISCONFIG @ rainbet-us-staging-rabbitmq.rainbet.com:15671/15672: management ports fluxing (timeout) — only prod broker stable.
...
## RANKED HYPOTHESES 2026-09-15 05:52:10 UTC
- [70] betpandacasino.io/rest/user: BetPanda Casino Authenticated /rest/user/* Endpoint Census via Credentialed Session (from art/lead_nemotron3.txt)
- [45] betpandacasino.io/rest/user: Casino authenticated /rest/user endpoint census via credentialed session (from art/lead_bigpickle.txt)
- NEXT(hypotheses-bigpickle.txt): HUMAN: register two credentialed affiliate test accounts on affiliates.betpanda.io under scoped authorization → cross-uid GET /rest/player/uid/{own} vs /rest/pl
- NEXT(hypotheses-nemotron3.txt): HUMAN: Obtain scoped credentialed session on betpandacasino.io (register test account) → enumerate authenticated /rest/user/* endpoints (me, profile, info, sett
- LEARN: REJECTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com:5671,5672 / rainbet-us-staging-rabbitmq.rainbet.com:5671,5672: AMQP protocol requires authentication — ano
- LEARN: ACCEPTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com / rainbet-us-staging-rabbitmq.rainbet.com: RabbitMQ Management UI (15671/15672) + AMQP (5671/5672) public 
...
## RANKED HYPOTHESES 2026-09-15 11:18:57 UTC
- [75] rainbet-com-rabbitmq.rainbet.com:5671: RainBet RabbitMQ Anonymous AMQP Protocol Access on Raw DigitalOcean Origins (from art/lead_nemotron3.txt)
- [50] api.777.dev/graphql: Staging GraphQL mutation pre-auth side-effect gap on api.777.dev (from art/lead_bigpickle.txt)
- NEXT(hypotheses-bigpickle.txt): HUMAN: register two credentialed affiliate test accounts on affiliates.betpanda.io under scoped authorization → cross-uid GET /rest/player/uid/{own} vs /rest/pl
- NEXT(hypotheses-nemotron3.txt): PROBE: openssl s_client -connect rainbet-com-rabbitmq.rainbet.com:5671 -quiet < /dev/null && nc -v rainbet-com-rabbitmq.rainbet.com 5672
- LEARN: ACCEPTED OTHER @ avatarux-studios live surface: passive convergence reconfirmed — 6 read-only GETs stable (casino /rest/user/details 200 301B, aff config 200 39
- LEARN: REJECTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com:5671,5672 / rainbet-us-staging-rabbitmq.rainbet.com:5671,5672: AMQP protocol requires authentication — ano
- LEARN: ACCEPTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com / rainbet-us-staging-rabbitmq.rainbet.com: RabbitMQ Management UI (15671/15672) + AMQP (5671/5672) public 
- LEARN: REJECTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com/api/*: /api/overview, /api/queues, /api/exchanges, /api/vhosts, /api/connections, /api/channels all 401 Ba
- LEARN: REJECTED MISCONFIG @ rainbet-us-staging-rabbitmq.rainbet.com:15671/15672: management ports fluxing (timeout) — only prod broker stable.
...
## RANKED HYPOTHESES 2026-09-15 19:27:04 UTC
- [75] rainbet-com-rabbitmq.rainbet.com:5671: RainBet RabbitMQ Anonymous AMQP Protocol Access on Raw DigitalOcean Origins (from art/lead_nemotron3.txt)
- [68] affiliates.betpanda.io/rest/player/uid/{uid}: Affiliate BOLA on /rest/player/uid/{uid} cross-uid iteration (from art/lead_bigpickle.txt)
- NEXT(hypotheses-nemotron3.txt): PROBE: openssl s_client -connect rainbet-com-rabbitmq.rainbet.com:5671 -quiet < /dev/null && nc -v rainbet-com-rabbitmq.rainbet.com 5672
- LEARN: REJECTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com:5671,5672 / rainbet-us-staging-rabbitmq.rainbet.com:5671,5672: AMQP protocol requires authentication — ano
...
- LEARN: ACCEPTED OTHER @ api.777.dev: live Express/session backend (connect.sid, helmet, ACAC:true preset, CF 104.18.43.25); prod CORS whitelist origin is a real runnin
- LEARN: ACCEPTED OTHER @ 777.dev zone: 11/11 cert-name members resolve to Roobet CF pair; non-resolving www.777.dev still reflects ACAO — namespace-trust evidence compl
- LEARN: ACCEPTED OTHER @ betpandecasino.io/rest/user/details: 200 JSON user-state model unauthenticated leak (301B) reconfirmed — report-ready finding unchanged, contro
- LEARN: ACCEPTED OTHER @ help.desk.avatarux.com portals: template size shifted 209005→207440B but tenant-id df607198-… + atlassianOrgId + Statsig leak intact, portals 4
- LEARN: ACCEPTED OTHER @ rainbet-com-rabbitmq.rainbet.com: :5671 AMQP-TLS OPEN stable; :5672 plaintext TIMEOUT (was OPEN) — prod broker now shows staging-like port flux
- LEARN: ACCEPTED OTHER @ avatarux-studios live surface: 4 read-only GETs + CORS re-verified — affiliates config cc5f885e byte-identical, casino details size-stable (geo
- LEARN: ACCEPTED OTHER @ api.777.dev/graphql: GET + `Apollo-Require-Preflight: true` → 200 anonymous introspection; 29Q/27M/62-field User schema fully mapped; stack tra
...
## RANKED HYPOTHESES 2026-09-15 22:27:35 UTC
- [70] betpandacasino.io/rest/user: BetPanda Casino Authenticated /rest/user/* Endpoint Census and Cross-Tenant Header Injection (from art/lead_nemotron3.txt)
- [45] roobet.com|stake.com|gamdom.com/rest/user/details: Cross-brand anonymous user-state parity via shared Nano/Spring /rest tenant family (from art/lead_bigpickle.txt)
- NEXT(hypotheses-bigpickle.txt): PROBE: 4 read-only GETs (browser UA, ≤0.2rps): https://gamebook.777.dev/ , https://promotions.777.dev/ , https://api-test.777.dev/ , https://api-lbc.777.dev/ — 
- NEXT(hypotheses-nemotron3.txt): HUMAN: Obtain scoped credentialed sessions for (1) betpandacasino.io (register test player account) and (2) affiliates.betpanda.io (issue two test affiliate acc
- LEARN: REJECTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com:5671,5672 / rainbet-us-staging-rabbitmq.rainbet.com:5671,5672: AMQP protocol requires authentication — ano
- LEARN: ACCEPTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com / rainbet-us-staging-rabbitmq.rainbet.com: RabbitMQ Management UI (15671/15672) + AMQP (5671/5672) public 
- LEARN: REJECTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com/api/*: /api/overview,/queues,/exchanges,/vhosts,/connections,/channels,/bindings,/permissions,/policies,/d
- LEARN: REJECTED MISCONFIG @ rainbet-us-staging-rabbitmq.rainbet.com:15671/15672: management ports fluxing (timeout) — only prod broker stable.
- LEARN: ACCEPTED OTHER @ api.777.dev/graphql: GET + `Apollo-Require-Preflight: true` → 200 anonymous introspection; 29Q/27M/62-field User schema fully mapped; stack tra
- LEARN: ACCEPTED AUTH @ api.777.dev/graphql: uniform global auth plugin — currentUser, notifications, polymarketUserPortfolio, AND control exchangeRates all NOT_AUTHENT
- LEARN: ACCEPTED MISCONFIG @ api.777.dev CORS: ACAO only for *.777.dev (evil777.dev/evil.example/null none) — suffix-match identical to prod /_api; staging whitelist co
...
## RANKED HYPOTHESES 2026-09-16 00:32:08 UTC
- [75] api.777.dev/graphql: Staging GraphQL Introspection and Anonymous Mutation Enumeration on api.777.dev (from art/lead_nemotron3.txt)
- [68] affiliates.betpanda.io/rest/player/uid/{uid}: Affiliate BOLA on /rest/player/uid/{uid} cross-uid iteration (from art/lead_bigpickle.txt)
- NEXT(hypotheses-bigpickle.txt): HUMAN: Issue scoped credentialed sessions — two test affiliate accounts (affiliates.betpanda.io) for /rest/player/uid/{own-vs-other} BOLA diff, plus one test pl
- NEXT(hypotheses-nemotron3.txt): PROBE: GET https://api.777.dev/graphql -H "Apollo-Require-Preflight: true" -H "Origin: https://www.777.dev" --max-time 10
- LEARN: ACCEPTED MISCONFIG @ crash-gs.roobet.com / dice.roobet.com: HTTP root + /health /api /socket.io all curl(28) timeout @12s — WS-transport-only game servers on Ro
- LEARN: ACCEPTED OTHER @ api.777.dev: live Express/session backend (connect.sid, helmet, ACAC:true preset, CF 104.18.43.25); prod CORS whitelist origin is a real runnin
- LEARN: ACCEPTED OTHER @ 777.dev zone: 11/11 cert-name members resolve to Roobet CF pair; non-resolving www.777.dev still reflects ACAO — namespace-trust evidence compl
- LEARN: ACCEPTED OTHER @ betpandecasino.io/rest/user/details: 200 JSON user-state model unauthenticated leak (301B) reconfirmed — report-ready finding unchanged, contro
...
## RANKED HYPOTHESES 2026-09-16 05:15:27 UTC
- [75] api.777.dev/graphql: Staging GraphQL Introspection and Anonymous Mutation Enumeration on api.777.dev (from art/lead_nemotron3.txt)
- [68] affiliates.betpanda.io/rest/player/uid/{uid}: Affiliate BOLA on /rest/player/uid/{uid} cross-uid iteration (from art/lead_bigpickle.txt)
- NEXT(hypotheses-bigpickle.txt): HUMAN: Issue scoped credentialed sessions — two test affiliate accounts (affiliates.betpanda.io) for /rest/player/uid/{own-vs-other} BOLA diff, plus one test pl
- NEXT(hypotheses-nemotron3.txt): PROBE: GET https://api.777.dev/graphql -H "Apollo-Require-Preflight: true" -H "Origin: https://www.777.dev" --max-time 10
...
## RANKED HYPOTHESES 2026-09-16 15:07:43 UTC
...
## RANKED HYPOTHESES 2026-09-17 00:06:13 UTC
- [45] betpandacasino.io/rest/user: BetPanda Casino authenticated /rest/user/* census + x-site-name-id tenant behavior (from art/lead_bigpickle.txt)
- NEXT(hypotheses-bigpickle.txt): HUMAN: standing credential grant required — two registered affiliate test accounts (BOLA-uid proof) and one casino session (user-state census); no further passi
- LEARN: ACCEPTED OTHER @ 777.dev siblings storybook/testsite/x/xtest: all 403 Cloudflare challenge 5480B, identical to gamebook/promotions/api-test/api-lbc — 8/8 siblin
- LEARN: ACCEPTED OTHER @ api.777.dev/graphql: GET + `Apollo-Require-Preflight: true` → 200 anonymous introspection; 29Q/27M/62-field User schema fully mapped; stack tra
- LEARN: ACCEPTED AUTH @ api.777.dev/graphql: uniform global auth plugin — currentUser, notifications, polymarketUserPortfolio, AND control exchangeRates all NOT_AUTHENT
...
## RANKED HYPOTHESES 2026-09-17 09:57:25 UTC
- [65] rainbet-com-rabbitmq.rainbet.com:5671/5672,: RainBet RabbitMQ Anonymous AMQP Wire Protocol Access on Raw DigitalOcean Origins (from art/lead_nemotron3.txt)
- NEXT(hypotheses-nemotron3.txt): PROBE: AMQP protocol handshake on RainBet production broker — `openssl s_client -connect rainbet-com-rabbitmq.rainbet.com:5671 -quiet < /dev/null 2>&1 | head -2
- LEARN: ACCEPTED OTHER @ api.777.dev/graphql: GET + `Apollo-Require-Preflight: true` → 200 anonymous introspection; 29Q/27M/62-field User schema fully mapped; stack tra
- LEARN: ACCEPTED AUTH @ api.777.dev/graphql: uniform global auth plugin — currentUser, notifications, polymarketUserPortfolio, AND control exchangeRates all NOT_AUTHENT
...
## RANKED HYPOTHESES 2026-09-17 14:52:13 UTC
- [65] rainbet-com-rabbitmq.rainbet.com:5671/5672,: RainBet RabbitMQ Anonymous AMQP Wire Protocol Access on Raw DigitalOcean Origins (from art/lead_nemotron3.txt)
- [62] roobet.com/_api/graphql: Production GraphQL field/prov argument blind enumeration finds anonymous data beyond tpGames (from art/lead_bigpickle.txt)
- NEXT(hypotheses-bigpickle.txt): PROBE: continue blind schema enumeration on roobet.com/_api/graphql — POST {"query":"{tpGames{id}}"} re-verify, then field-dictionary probes `{"query":"{<candid
- NEXT(hypotheses-nemotron3.txt): PROBE: openssl s_client -connect rainbet-com-rabbitmq.rainbet.com:5671 -quiet < /dev/null 2>&1 | head -20 && nc -vz rainbet-com-rabbitmq.rainbet.com 5672 2>&1 &
- LEARN: ACCEPTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com:5671/5672: Management UI (15671/15672) + AMQP (5671/5672) public on raw DigitalOcean origins, no CF/ACL; /
- LEARN: ACCEPTED OTHER @ staging-api.rainbet.com: x-do-app-origin UUID 1ce4ff55 leaked through Cloudflare on 200-empty
...
- LEARN: ACCEPTED OTHER @ roobet.com/_api CORS: namespace-wide *.777.dev suffix match with ACAC:true, but connect.sid SameSite=Lax+HttpOnly breaks cross-origin credentia
- LEARN: ACCEPTED OTHER @ api.777.dev/graphql: anonymous introspection 200 mapped schema, uniform auth plugin NOT_AUTHENTICATED on all Query fields, mutation gap REJECTE
...
- LEARN: ACCEPTED OTHER @ roobet.com/_api CORS: whitelist is namespace-wide (any *.777.dev incl. dead DNS) with credentials=true — staging-to-prod trust root is the whol
- LEARN: REJECTED MISCONFIG @ CORS substring/prefix hypothesis: evil777.dev, 777.dev.evil.com, http://777.dev, null all no-reflection — whitelist uses proper domain-suff
- LEARN: ACCEPTED MISCONFIG @ crash-gs.roobet.com / dice.roobet.com: HTTP root + /health /api /socket.io all curl(28) timeout @12s — WS-transport-only game servers, NO a
...
## RANKED HYPOTHESES 2026-09-17 18:51:56 UTC
- [68] affiliates.betpanda.io/rest/player/uid/{uid}: Affiliates.betpanda.io BOLA /rest/player/uid cross-UID iteration (from art/lead_bigpickle.txt)
- [65] rainbet-com-rabbitmq.rainbet.com:5671/5672,: RainBet RabbitMQ Anonymous AMQP Wire Protocol Access on Raw DigitalOcean Origins (from art/lead_nemotron3.txt)
- NEXT(hypotheses-bigpickle.txt): PROBE: continue blind schema enumeration on roobet.com/_api/graphql — POST {"query":"{tpGames{id}}"} re-verify, then field-dictionary probes `{"query":"{<candid
- NEXT(hypotheses-nemotron3.txt): PROBE: openssl s_client -connect rainbet-com-rabbitmq.rainbet.com:5671 -quiet < /dev/null 2>&1 | head -20 && nc -vz rainbet-com-rabbitmq.rainbet.com 5672 2>&1 &
- LEARN: ACCEPTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com:5671/5672: Management UI (15671/15672) + AMQP (5671/5672) public on raw DigitalOcean origins, no CF/ACL; /
...
## RANKED HYPOTHESES 2026-09-17 21:57:02 UTC
- [65] rainbet-com-rabbitmq.rainbet.com:5671/5672,: RainBet RabbitMQ Anonymous AMQP Wire Protocol Access on Raw DigitalOcean Origins (from art/lead_nemotron3.txt)
- [45] betpandacasino.io/rest/user: BetPanda Casino authenticated /rest/user/* census + x-site-name-id tenant behavior (from art/lead_bigpickle.txt)
- NEXT(hypotheses-bigpickle.txt): HUMAN: standing credential grant — two registered affiliate test accounts on affiliates.betpanda.io (BOLA proof: GET /rest/player/uid/{own} vs {other}) + one be
- NEXT(hypotheses-nemotron3.txt): PROBE: openssl s_client -connect rainbet-com-rabbitmq.rainbet.com:5671 -quiet < /dev/null 2>&1 | head -20 && nc -vz rainbet-com-rabbitmq.rainbet.com 5672 2>&1 &
- LEARN: ACCEPTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com:5671/5672: Management UI (15671/15672) + AMQP (5671/5672) public on raw DigitalOcean origins, no CF/ACL; /
- LEARN: ACCEPTED OTHER @ staging-api.rainbet.com: x-do-app-origin UUID 1ce4ff55 leaked through Cloudflare on 200-empty
- LEARN: ACCEPTED MISCONFIG @ betpandecasino.io/rest/user/details: NEW unauthenticated endpoint returning full user state model (301B JSON)
...
## RANKED HYPOTHESES 2026-09-17 23:55:47 UTC
- [65] rainbet-com-rabbitmq.rainbet.com:5671/5672,: RainBet RabbitMQ Anonymous AMQP Wire Protocol Access on Raw DigitalOcean Origins (from art/lead_nemotron3.txt)
- NEXT(hypotheses-bigpickle.txt): PROBE: openssl s_client -connect rainbet-com-rabbitmq.rainbet.com:5671 -quiet < /dev/null 2>&1 | head -20 && nc -vz rainbet-com-rabbitmq.rainbet.com 5672 2>&1 &
- NEXT(hypotheses-nemotron3.txt): PROBE: openssl s_client -connect rainbet-com-rabbitmq.rainbet.com:5671 -quiet < /dev/null 2>&1 | head -20 && nc -vz rainbet-com-rabbitmq.rainbet.com 5672 2>&1 &
- LEARN: ACCEPTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com:5671/5672: Management UI (15671/15672) + AMQP (5671/5672) public on raw DigitalOcean origins, no CF/ACL; /
- LEARN: ACCEPTED OTHER @ staging-api.rainbet.com: x-do-app-origin UUID 1ce4ff55 leaked through Cloudflare on 200-empty
- LEARN: ACCEPTED MISCONFIG @ betpandecasino.io/rest/user/details: NEW unauthenticated endpoint returning full user state model (301B JSON)
...
## RANKED HYPOTHESES 2026-09-18 03:14:32 UTC
- [68] affiliates.betpanda.io/rest/player/uid/{uid}: Affiliates.betpanda.io BOLA /rest/player/uid cross-UID iteration (from art/lead_bigpickle.txt)
- [65] rainbet-com-rabbitmq.rainbet.com:5671/5672,: RainBet RabbitMQ Anonymous AMQP Wire Protocol Access on Raw DigitalOcean Origins (from art/lead_nemotron3.txt)
- NEXT(hypotheses-nemotron3.txt): PROBE: openssl s_client -connect rainbet-com-rabbitmq.rainbet.com:5671 -quiet < /dev/null 2>&1 | head -20 && nc -vz rainbet-com-rabbitmq.rainbet.com 5672 2>&1 &
- LEARN: ACCEPTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com:5671/5672: Management UI (15671/15672) + AMQP (5671/5672) public on raw DigitalOcean origins, no CF/ACL; /
...
## RANKED HYPOTHESES 2026-09-18 08:24:24 UTC
- [68] affiliates.betpanda.io/rest/player/uid/{uid}: Affiliates.betpanda.io BOLA /rest/player/uid cross-UID iteration (from art/lead_bigpickle.txt)
- [65] rainbet-com-rabbitmq.rainbet.com:5671/5672,: RainBet RabbitMQ Anonymous AMQP Wire Protocol Access on Raw DigitalOcean Origins (from art/lead_nemotron3.txt)
- NEXT(hypotheses-bigpickle.txt): HUMAN: standing credential grant — two registered affiliate test accounts on affiliates.betpanda.io (GET /rest/player/uid/{own} vs {other}, cookie A then B) + o
- NEXT(hypotheses-nemotron3.txt): PROBE: openssl s_client -connect rainbet-com-rabbitmq.rainbet.com:5671 -quiet < /dev/null 2>&1 | head -20 && nc -vz rainbet-com-rabbitmq.rainbet.com 5672 2>&1 &
- LEARN: ACCEPTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com:5671/5672: Management UI (15671/15672) + AMQP (5671/5672) public on raw DigitalOcean origins, no CF/ACL; /
- LEARN: ACCEPTED OTHER @ staging-api.rainbet.com: x-do-app-origin UUID 1ce4ff55 leaked through Cloudflare on 200-empty
- LEARN: ACCEPTED MISCONFIG @ betpandecasino.io/rest/user/details: NEW unauthenticated endpoint returning full user state model (301B JSON)
...
## RANKED HYPOTHESES 2026-09-18 13:11:53 UTC
- [68] affiliates.betpanda.io/rest/player/uid/{uid}: Affiliates.betpanda.io BOLA /rest/player/uid cross-UID iteration (from art/lead_bigpickle.txt)
- [65] rainbet-com-rabbitmq.rainbet.com:5671/5672,: RainBet RabbitMQ Anonymous AMQP Wire Protocol Access on Raw DigitalOcean Origins (from art/lead_nemotron3.txt)
- NEXT(hypotheses-nemotron3.txt): PROBE: openssl s_client -connect rainbet-com-rabbitmq.rainbet.com:5671 -quiet < /dev/null 2>&1 | head -20 && nc -vz rainbet-com-rabbitmq.rainbet.com 5672 2>&1 &
- LEARN: ACCEPTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com:5671/5672: Management UI (15671/15672) + AMQP (5671/5672) public on raw DigitalOcean origins, no CF/ACL; /
...
## RANKED HYPOTHESES 2026-09-18 17:12:18 UTC
- [70] affiliates.betpanda.io/rest/player/uid/{uid}: Affiliates.betpanda.io BOLA on /rest/player/uid/{uid} Cross-UID Iteration (from art/lead_bigpickle.txt)
- [65] rainbet-com-rabbitmq.rainbet.com:5671/5672,: RainBet RabbitMQ Anonymous AMQP Wire Protocol Access on Raw DigitalOcean Origins (from art/lead_nemotron3.txt)
- NEXT(hypotheses-bigpickle.txt): PROBE: openssl s_client -connect rainbet-com-rabbitmq.rainbet.com:5671 -quiet < /dev/null 2>&1 | head -20 && nc -vz rainbet-com-rabbitmq.rainbet.com 5672 2>&1 &
- NEXT(hypotheses-nemotron3.txt): PROBE: openssl s_client -connect rainbet-com-rabbitmq.rainbet.com:5671 -quiet < /dev/null 2>&1 | head -20 && nc -vz rainbet-com-rabbitmq.rainbet.com 5672 2>&1 &
- LEARN: ACCEPTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com:5671/5672: Management UI (15671/15672) + AMQP (5671/5672) public on raw DigitalOcean origins, no CF/ACL; /
...
## RANKED HYPOTHESES 2026-09-18 19:45:10 UTC
- [65] rainbet-com-rabbitmq.rainbet.com:5671/5672,: RainBet RabbitMQ Anonymous AMQP Wire Protocol Access on Raw DigitalOcean Origins (from art/lead_nemotron3.txt)
- [45] betpandacasino.io/rest/user: BetPanda Casino authed /rest/user/* census + x-site-name-id tenant behavior (from art/lead_bigpickle.txt)
- NEXT(hypotheses-bigpickle.txt): HUMAN: standing credential grant — two registered affiliate test accounts on affiliates.betpanda.io (GET /rest/player/uid/{own} vs {other}, cookie A then B) + o
- NEXT(hypotheses-nemotron3.txt): PROBE: openssl s_client -connect rainbet-com-rabbitmq.rainbet.com:5671 -quiet < /dev/null 2>&1 | head -20 && nc -vz rainbet-com-rabbitmq.rainbet.com 5672 2>&1 &
- LEARN: ACCEPTED OTHER @ blog.betpandacasino.io: full anonymous WP author set = exactly 2 published accounts (per_page=100 confirmed); hidden author slots uid3/uid4 401
...
- LEARN: ACCEPTED OTHER @ avatarux-studios live surface: 7 read-only probes re-verified byte-stable (aff config cc5f885e 398B; casino details 4254af73 301B; help.desk po
- LEARN: ACCEPTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com:5671/5672: Management UI (15671/15672) + AMQP (5671/5672) public on raw DigitalOcean origins, no CF/ACL; /
- LEARN: ACCEPTED OTHER @ staging-api.rainbet.com: x-do-app-origin UUID 1ce4ff55 leaked through Cloudflare on 200-empty
- LEARN: ACCEPTED MISCONFIG @ betpandecasino.io/rest/user/details: NEW unauthenticated endpoint returning full user state model (301B JSON)
- LEARN: ACCEPTED MISCONFIG @ help.desk.avatarux.com portals 4–100: surface expanded to 96+ portals, all leaking identical tenant-id/atlassianOrgId/Statsig config
...
## RANKED HYPOTHESES 2026-09-18 22:19:11 UTC
- [65] rainbet-com-rabbitmq.rainbet.com:5671/5672,: RainBet RabbitMQ Anonymous AMQP Wire Protocol Access on Raw DigitalOcean Origins (from art/lead_nemotron3.txt)
- [45] betpandacasino.io/rest/user: BetPanda Casino authed /rest/user/* census + x-site-name-id tenant binding (canonical host) (from art/lead_bigpickle.txt)
- NEXT(hypotheses-bigpickle.txt): HUMAN: standing credential grant — two registered affiliate test accounts on affiliates.betpanda.io (GET /rest/player/uid/{own} vs {other}, cookie A then B) + o
- NEXT(hypotheses-nemotron3.txt): PROBE: openssl s_client -connect rainbet-com-rabbitmq.rainbet.com:5671 -quiet < /dev/null 2>&1 | head -20 && nc -vz rainbet-com-rabbitmq.rainbet.com 5672 2>&1 &
- LEARN: ACCEPTED OTHER @ blog.betpandacasino.io: full anonymous WP author set = exactly 2 published accounts (per_page=100 confirmed); hidden author slots uid3/uid4 401
- LEARN: REJECTED MISCONFIG @ blog.betpandacasino.io: author-id slot oracle (401-vs-404 existence) — REJECTED username-enumeration class, non-reportable.
- LEARN: ACCEPTED OTHER @ avatarux-studios live surface: 7 read-only probes re-verified byte-stable (aff config cc5f885e 398B; casino details 4254af73 301B; help.desk po
- LEARN: ACCEPTED OTHER @ blog.betpandacasino.io/wp-json: posts (200, public marketing content IDs 76000+), media (200, public webp), pages (200, 4 locale pages), commen
- LEARN: REJECTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com:5671: TLS handshake re-verified (valid LE cert, correct CN), empty connect returns no AMQP banner — with 0
- LEARN: ACCEPTED OTHER @ avatarux-studios live surface: 4 read-only probes byte-stable this cycle (aff config cc5f885e 398B; casino details 4254af73 301B; blog REST 200
- LEARN: ACCEPTED OTHER @ blog.betpandacasino.io: full anonymous WP author set = exactly 2 published accounts (per_page=100 confirmed); hidden author slots uid3/uid4 401
- LEARN: REJECTED MISCONFIG @ blog.betpandacasino.io: author-id slot oracle (401-vs-404 existence) — REJECTED username-enumeration class, non-reportable.
- LEARN: ACCEPTED OTHER @ avatarux-studios live surface: 7 read-only probes re-verified byte-stable (aff config cc5f885e 398B; casino details 4254af73 301B; help.desk po
- LEARN: ACCEPTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com:5671/5672: Management UI (15671/15672) + AMQP (5671/5672) public on raw DigitalOcean origins, no CF/ACL; /
...
## RANKED HYPOTHESES 2026-09-19 00:26:41 UTC
- [68] affiliates.betpanda.io/rest/player/uid/{uid}: Affiliates.betpanda.io BOLA /rest/player/uid cross-UID iteration (from art/lead_bigpickle.txt)
- [65] rainbet-com-rabbitmq.rainbet.com:5671/5672,: RainBet RabbitMQ Anonymous AMQP Wire Protocol Access on Raw DigitalOcean Origins (from art/lead_nemotron3.txt)
- NEXT(hypotheses-bigpickle.txt): HUMAN: standing credential grant — two registered affiliate test accounts on affiliates.betpanda.io (GET /rest/player/uid/{own} vs {other}, cookie A then B; dif
- NEXT(hypotheses-nemotron3.txt): PROBE: openssl s_client -connect rainbet-com-rabbitmq.rainbet.com:5671 -quiet < /dev/null 2>&1 | head -20 && nc -vz rainbet-com-rabbitmq.rainbet.com 5672 2>&1 &
- LEARN: ACCEPTED MISCONFIG @ avatarux-studios live surface: 5 read-only probes re-verified byte-stable this cycle — aff config 200/398B sha256 cc5f885e, casino details 
- LEARN: REJECTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com:5671: TLS handshake re-verified (valid LE cert, correct CN), empty connect returns no AMQP banner — with 0
- LEARN: ACCEPTED MISCONFIG @ betpandacasino.io/rest/user/details: NEW unauthenticated endpoint returning full user state model (301B JSON) — stable across 30+ probes, r
- LEARN: ACCEPTED MISCONFIG @ help.desk.avatarux.com portals 4–100: surface expanded to 96+ portals, all leaking identical tenant-id/atlassianOrgId/Statsig config — pass
- LEARN: ACCEPTED OTHER @ roobet.com/_api CORS: namespace-wide *.777.dev suffix match with ACAC:true, but connect.sid SameSite=Lax+HttpOnly breaks cross-origin credentia
- LEARN: ACCEPTED OTHER @ api.777.dev/graphql: anonymous introspection 200 mapped schema, uniform auth plugin NOT_AUTHENTICATED on all Query fields, mutation gap REJECTE
- LEARN: REJECTED MISCONFIG @ betpandacasino.io/rest/user/details x-site-name-id: stake_com → body/ACAO/echo unchanged — no passive tenant switch
- LEARN: REJECTED MISCONFIG @ betpandacasino.io/rest/public/config: Spring JSON 404 — casino does NOT mirror affiliates config leak; passive corroboration gap CLOSED
- LEARN: REJECTED MISCONFIG @ betpandecasino.io/rest/callback|webhook|notify|game/callback|api/game/callback: all 404 — SSRF hypothesis falsified, passive surface exhaus
- LEARN: ACCEPTED MISCONFIG @ cpanel.avatarux.com: NS/SOA confirms Bluehost apex delegation, no claimable subdomain delegation — takeover unproven, monitoring only
- LEARN: REJECTED AUTH @ affiliates.betpanda.io/rest/public/recover-password: forgot-password timing enumeration is REJECTED class (program scope) — must not be reranked
...
## RANKED HYPOTHESES 2026-09-19 05:02:56 UTC
- [68] affiliates.betpanda.io/rest/player/uid/{uid}: Affiliates.betpanda.io BOLA /rest/player/uid cross-UID iteration (from art/lead_bigpickle.txt)
- [65] rainbet-com-rabbitmq.rainbet.com:5671/5672,: RainBet RabbitMQ Anonymous AMQP Wire Protocol Access on Raw DigitalOcean Origins (from art/lead_nemotron3.txt)
- NEXT(hypotheses-bigpickle.txt): HUMAN: standing credential grant — two registered affiliate test accounts on affiliates.betpanda.io (GET /rest/player/uid/{own} vs {other}, cookie A then B) + o
- NEXT(hypotheses-nemotron3.txt): PROBE: openssl s_client -connect rainbet-com-rabbitmq.rainbet.com:5671 -quiet < /dev/null 2>&1 | head -20 && nc -vz rainbet-com-rabbitmq.rainbet.com 5672 2>&1 &
- LEARN: REJECTED MISCONFIG @ affiliates.betpanda.io/rest/{trk/agent/public/locales}: all 404 Spring XML-Map route-miss — last unmapped endpoint-map families closed anon
- LEARN: ACCEPTED OTHER @ avatarux-studios live surface: 5 probes byte-stable (aff config cc5f885e 398B; casino details 4254af73 301B; rmq :15671 401 Basic; roobet ACAO 
- LEARN: ACCEPTED MISCONFIG @ betpandacasino.io/rest/user/details: NEW unauthenticated endpoint returning full user state model (301B JSON) — stable across 30+ probes, r
- LEARN: ACCEPTED MISCONFIG @ help.desk.avatarux.com portals 4–100: surface expanded to 96+ portals, all leaking identical tenant-id/atlassianOrgId/Statsig config — pass
- LEARN: ACCEPTED OTHER @ roobet.com/_api CORS: namespace-wide *.777.dev suffix match with ACAC:true, but connect.sid SameSite=Lax+HttpOnly breaks cross-origin credentia
- LEARN: ACCEPTED OTHER @ api.777.dev/graphql: anonymous introspection 200 mapped schema, uniform auth plugin NOT_AUTHENTICATED on all Query fields, mutation gap REJECTE
...
- LEARN: ACCEPTED MISCONFIG @ cpanel.avatarux.com: NS/SOA confirms Bluehost apex delegation, no claimable subdomain delegation — takeover unproven, monitoring only
- LEARN: REJECTED AUTH @ affiliates.betpanda.io/rest/public/recover-password: forgot-password timing enumeration is REJECTED class (program scope) — must not be reranked
- LEARN: REJECTED MISCONFIG @ Stake/Gamdom/RainBet game-tier mirror: no *.games
- LEARN: REJECTED MISCONFIG @ Stake/Gamdom/RainBet game-tier mirror: no *.games/crash-*/dice CT labels — Roobet stand-alone stack unique, parity hypothesis closed
- LEARN: REJECTED MISCONFIG @ rainbet-com-rabbitmq.rainbet.com:15671/api/queues: anonymous queue enumeration falsified — HTTP 401 Basic identical to /api/overview; manag
- LEARN: ACCEPTED OTHER @ roobet.com/_api CORS: whitelist is namespace-wide (any *.777.dev incl. dead DNS) with credentials=true — staging-to-prod trust root is the whol
- LEARN: REJECTED MISCONFIG @ CORS substring/prefix hypothesis: evil777.dev, 777.dev.evil.com, http://777.dev, null all no-reflection — whitelist uses proper domain-suff
...
## RANKED HYPOTHESES 2026-09-19 09:25:30 UTC
- [90] betpandacasino.io/rest/user/details: BetPanda Casino Unauthenticated User State Model Disclosure via /rest/user/details (from art/lead_nemotron3.txt)
- [68] affiliates.betpanda.io/rest/player/uid/{uid}: Affiliates.betpanda.io BOLA /rest/player/uid cross-UID iteration (from art/lead_bigpickle.txt)
- NEXT(hypotheses-bigpickle.txt): HUMAN: standing credential grant — two registered affiliate test accounts on affiliates.betpanda.io (GET /rest/player/uid/{own} vs {other}, cookie A then B; dif
- NEXT(hypotheses-nemotron3.txt): PROBE: openssl s_client -connect rainbet-com-rabbitmq.rainbet.com:5671 -quiet < /dev/null 2>&1 | head -20 && nc -vz rainbet-com-rabbitmq.rainbet.com 5672 2>&1 &
- LEARN: ACCEPTED OTHER @ avatarux-studios live surface: 5 read-only probes byte-stable — aff config 200/398B cc5f885e, casino details 200/301B 4254af73, blog users 200/
- LEARN: ACCEPTED MISCONFIG @ betpandacasino.io/rest/user/details: NEW unauthenticated endpoint returning full user state model (301B JSON) — stable across 30+ probes, r
- LEARN: ACCEPTED MISCONFIG @ help.desk.avatarux.com portals 4–100: surface expanded from 7 to 96+ portals, all leaking identical tenant-id/atlassianOrgId/Statsig config
- LEARN: ACCEPTED OTHER @ roobet.com/_api CORS: namespace-wide *.777.dev suffix match with ACAC:true, but connect.sid SameSite=Lax+HttpOnly breaks cross-origin credentia
- LEARN: ACCEPTED OTHER @ api.777.dev/graphql: anonymous introspection 200 mapped schema, uniform auth plugin NOT_AUTHENTICATED on all Query fields, mutation gap REJECTE
- LEARN: REJECTED MISCONFIG @ betpandacasino.io/rest/user/details x-site-name-id: stake_com → body/ACAO/echo unchanged — no passive tenant switch
- LEARN: REJECTED MISCONFIG @ betpandacasino.io/rest/public/config: Spring JSON 404 — casino does NOT mirror affiliates config leak; passive corroboration gap CLOSED
...
## RANKED HYPOTHESES 2026-09-19 13:26:15 UTC
- [90] betpandacasino.io/rest/user/details: BetPanda Casino Unauthenticated User State Model Disclosure via /rest/user/details (from art/lead_nemotron3.txt)
- NEXT(hypotheses-nemotron3.txt): PROBE: openssl s_client -connect rainbet-com-rabbitmq.rainbet.com:5671 -quiet < /dev/null 2>&1 | head -20 && nc -vz rainbet-com-rabbitmq.rainbet.com 5672 2>&1 &
- LEARN: ACCEPTED MISCONFIG @ betpandacasino.io/rest/user/details: NEW unauthenticated endpoint returning full user state model (301B JSON) — stable across 30+ probes, r
- LEARN: ACCEPTED MISCONFIG @ help.desk.avatarux.com portals 4–100: surface expanded from 7 to 96+ portals, all leaking identical tenant-id/atlassianOrgId/Statsig config
...
## RANKED HYPOTHESES 2026-09-19 16:51:36 UTC
- [100] (none: No GitHub org candidates configured for source-code audit (from art/lead_bigpickle.txt)
- [90] betpandacasino.io/rest/user/details: BetPanda Casino Unauthenticated User State Model Disclosure via /rest/user/details (from art/lead_nemotron3.txt)
- NEXT(hypotheses-bigpickle.txt): HUMAN: standing credential grant — two registered affiliate test accounts on affiliates.betpanda.io (GET /rest/player/uid/{own} vs /{other}, cookie A then B; di
- NEXT(hypotheses-nemotron3.txt): PROBE: openssl s_client -connect rainbet-com-rabbitmq.rainbet.com:5671 -quiet < /dev/null 2>&1 | head -20 && nc -vz rainbet-com-rabbitmq.rainbet.com 5672 2>&1 &
- LEARN: ACCEPTED OTHER @ avatarux-studios live surface: 5 read-only probes byte/status-stable — aff config 200/398B cc5f885e; casino details 200/301B 4254af73; rmq :156
- LEARN: ACCEPTED MISCONFIG @ betpandacasino.io/rest/user/details: NEW unauthenticated endpoint returning full user state model (301B JSON) — stable across 30+ probes, r
- LEARN: ACCEPTED MISCONFIG @ help.desk.avatarux.com portals 4–100: surface expanded from 7 to 96+ portals, all leaking identical tenant-id/atlassianOrgId/Statsig config
- LEARN: ACCEPTED OTHER @ roobet.com/_api CORS: namespace-wide *.777.dev suffix match with ACAC:true, but connect.sid SameSite=Lax+HttpOnly breaks cross-origin credentia
- LEARN: ACCEPTED OTHER @ api.777.dev/graphql: anonymous introspection 200 mapped schema, uniform auth plugin NOT_AUTHENTICATED on all Query fields, mutation gap REJECTE
...
## RANKED HYPOTHESES 2026-09-19 19:15:25 UTC
- [90] betpandacasino.io/rest/user/details: BetPanda Casino Unauthenticated User-State Model Disclosure via /rest/user/details (from art/lead_bigpickle.txt)
- [75] rainbet-com-rabbitmq.rainbet.com:5671,: RainBet RabbitMQ Anonymous AMQP 0-9-1 Wire Protocol Access on Raw DigitalOcean Origins (from art/lead_nemotron3.txt)
- NEXT(hypotheses-bigpickle.txt): HUMAN: standing credential grant — two registered affiliate test accounts on affiliates.betpanda.io (GET /rest/player/uid/{own} vs /{other}, cookie A then B; di
- NEXT(hypotheses-nemotron3.txt): PROBE: openssl s_client -connect rainbet-com-rabbitmq.rainbet.com:5671 -quiet < /dev/null 2>&1 | head -20 && python3 -c "import pika; c=pika.BlockingConnection(
- LEARN: ACCEPTED MISCONFIG @ betpandacasino.io/rest/user/details: NEW unauthenticated endpoint returning full user state model (301B JSON) — stable across 30+ probes, r
- LEARN: ACCEPTED MISCONFIG @ help.desk.avatarux.com portals 4–100: surface expanded from 7 to 96+ portals, all leaking identical tenant-id/atlassianOrgId/Statsig config
- LEARN: ACCEPTED OTHER @ roobet.com/_api CORS: namespace-wide *.777.dev suffix match with ACAC:true, but connect.sid SameSite=Lax+HttpOnly breaks cross-origin credentia
- LEARN: ACCEPTED OTHER @ api.777.dev/graphql: anonymous introspection 200 mapped schema, uniform auth plugin NOT_AUTHENTICATED on all Query fields, mutation gap REJECTE
