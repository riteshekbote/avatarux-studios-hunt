# avatarux-studios-hunt

24/7 deep multi-model bug-hunting automation for **AvatarUX Studios** (Oliver Maicher bug-bounty hub).

Scope: Brands: Roobet, Stake, Gamdom, BetPanda, RainBet. All infrastructure, game services, APIs and systems operated by AvatarUX Studios and its distributed gaming integrations
...
> is never accepted. Active testing is gated behind the in-scope hosts in `inventory/avatarux-studios.md` and
...
Program description: Online slot game developer for iGaming platforms
